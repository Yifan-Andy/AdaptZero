...
if __name__ == "__main__":
    ...
    feature_path = f"checkpoints/processed_features/{args.dataset}_full.pt"
    ...
    np.save(args.embedding_path + args.dataset + '_mlp_full.npy', node_embedding)
