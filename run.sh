...
python mlp_pretrain_stable.py --dataset citeseer --batch_size 3327 --epochs 100 --dropout 0.1 --hidden_dim 512 --hops 5 --peak_lr 0.01 --weight_decay 1e-05 --device 1
...
python mlp_pretrain_stable.py --dataset pubmed --batch_size 19717 --epochs 100 --dropout 0.1 --hidden_dim 512 --hops 5 --peak_lr 0.01 --weight_decay 1e-05 --device 1
...
python mlp_pretrain_stable.py --dataset cocs --batch_size 18333 --epochs 100 --dropout 0.1 --hidden_dim 512 --hops 5 --peak_lr 0.01 --weight_decay 1e-05 --device 1
...
python mlp_pretrain_stable.py --dataset texas --batch_size 183 --epochs 100 --dropout 0.1 --hidden_dim 128 --hops 5 --peak_lr 0.01 --weight_decay 1e-05 --device 1
...
python mlp_pretrain_stable.py --dataset cornell --batch_size 183 --epochs 100 --dropout 0.1 --hidden_dim 128 --hops 5 --peak_lr 0.01 --weight_decay 1e-05 --device 1
...
python mlp_pretrain_stable.py --dataset actor --batch_size 7600 --epochs 100 --dropout 0.1 --hidden_dim 512 --hops 5 --peak_lr 0.001 --weight_decay 1e-05 --device 1
...
python mlp_pretrain_stable.py --dataset photo --batch_size 7650 --epochs 100 --dropout 0.1 --hidden_dim 128 --hops 5 --peak_lr 0.01 --weight_decay 1e-05 --device 1
...
python mlp_pretrain_stable.py --dataset wikics --batch_size 11701 --epochs 100 --dropout 0.1 --hidden_dim 128 --hops 5 --peak_lr 0.01 --weight_decay 1e-05 --device 1
...
python mlp_pretrain_stable.py --dataset reddit --alpha 0.01 --epochs 100 --batch_size 4000 --dropout 0.1 --hidden_dim 512 --hops 5 --peak_lr 0.001 --weight_decay 1e-05 --device 1
...
python mlp_pretrain_stable.py --dataset products --alpha 0.01 --epochs 100 --batch_size 4000 --dropout 0.1 --hidden_dim 512 --hops 5 --peak_lr 0.001 --weight_decay 1e-05 --device 1
