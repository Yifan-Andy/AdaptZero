# Pre-train with stable X and ADJ
...
if __name__ == "__main__":
    ...
    feature_path = f"checkpoints/processed_features/{args.dataset}_stable.pt"
    ...
    np.save(args.embedding_path + args.dataset + '_mlp_stable.npy', node_embedding)
