...
from utils import parse_args, transform_coo_to_csr, transform_sp_csr_to_coo, build_knn_sparse_adj, build_knn_sparse_adj_batch
...
if __name__ == "__main__":
    ...
    feature_path = f"checkpoints/processed_features/{args.dataset}_x.pt"
    ...
    np.save(args.embedding_path + args.dataset + '_mlp_x.npy', node_embedding)
